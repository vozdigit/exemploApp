!function(document, window, $) {
    ...
    $(document).ready(function($) {
        ...
        $("#exampleFilter").on("click", function() {
            filtered === !1 ? ($("#exampleFiltering").slick("slickFilter", ":even"),
            $(this).text("Unfilter Slides"),
            filtered = !0) : ($("#exampleFiltering").slick("slickUnfilter"),
            $(this).text("Filter Slides"),
            filtered = !1)
        })
        
        $('.owl-carousel').owlCarousel({nav:true});
        $('.owl-carousel-centered').owlCarousel({nav:true});
        $('.owl-carousel-logo').owlCarousel({dots:true,center:true});
        $('.owl-carousel-portfolio').owlCarousel({margin:100});
    });
