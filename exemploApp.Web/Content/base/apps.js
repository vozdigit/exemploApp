...
var handlePanelAction = function () {
    "use strict";
    $("[data-click=panel-new]").hover(function () {
        $(this).tooltip({
            title: "Novo",
            placement: "bottom",
            trigger: "hover",
...
var handleCaixaAlta = function () {
    $(".caixaAlta").keyup(function () {
        $(this).val($(this).val().toUpperCase());
    });
};

var handleSomenteNumero = function () {
    $(".somenteNumero").keypress(function (e) {
...
var handleMultiselect = function () {
    ...
    $('.multiselect').each(function (i, e) {

        var textoPrimeiroItem = $(e).attr('data-texto-primeiro-item');
        ...
        $(e).multiselect({
            ...
            buttonText: function (options) {
                if (options.length == 0) {
                    return ' ' + textoPrimeiroItem;
                }
                else if (options.length > 5) {
                    return options.length + ' itens selecionados';
                }
                else {
                    var selected = '';
...
var App = function () {
    ...
    return {
        init: function () {
            if ($("#content").attr("iniciado") == undefined) {
