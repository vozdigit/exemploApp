...
!(function (factory) {
    ...
    ParsleyAbstract.prototype = {
        ...
        reset: function () {
            ...
            //// Alteração Murilo: Removendo os sem identificadores adicionado a mão.
            $(".parsley-undefined").remove()
        },
    ...
    */
    ...
    window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
        ...
        mincheck: "Você deve escolher pelo menos %s op��es.",
    ...
    if ('undefined' !== typeof window.ParsleyValidator)
        window.ParsleyValidator.addCatalog('en', ParsleyConfig.i18n.en, true);
