...
{
    /// <summary>
    /// Classe responsável pela manipulação da entidade <see cref="RepositorioPerfil"/>.
    /// </summary>
    public class RepositorioPerfil : RepositorioId<Perfil>, IRepositorioPerfil
    {
        #region Construtores

        /// <summary>
        /// Cria uma instância de <see cref="RepositorioPerfil"/>.
        /// </summary>
        /// <param name="sessao">O objeto sessão.</param>
        /// <param name="usuario">O usuario.</param>
        public RepositorioPerfil(ISession sessao, IUsuarioLogado usuario)
            : base(sessao)
        {
