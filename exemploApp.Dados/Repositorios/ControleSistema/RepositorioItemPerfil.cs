...
{
    /// <summary>
    /// Classe responsável pela manipulação da entidade <see cref="RepositorioItemPerfil"/>.
    /// </summary>
    public class RepositorioItemPerfil : RepositorioId<ItemPerfil>, IRepositorioItemPerfil
    {
        #region Construtores

        /// <summary>
        /// Cria uma instância de <see cref="RepositorioItemPerfil"/>.
        /// </summary>
        /// <param name="sessao">O objeto sessão.</param>
        /// <param name="usuario">O usuario.</param>
        public RepositorioItemPerfil(ISession sessao, IUsuarioLogado usuario)
            : base(sessao)
        {
